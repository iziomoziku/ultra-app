...
namespace Api.Migrations
{
    ...
    [Migration("20250122173522_updateschedule11")]
    partial class updateschedule11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Exercise", b =>
                {
                    ...
                    b.Property<string>("ScheduleUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ScheduleId", "ScheduleUserId");
            ...
            modelBuilder.Entity("api.Models.Exercise", b =>
                {
                    ...
                    b.HasOne("api.Models.Schedule", null)
                        .WithMany("Exercises")
                        .HasForeignKey("ScheduleId", "ScheduleUserId")
                        .OnDelete(DeleteBehavior.NoAction);
