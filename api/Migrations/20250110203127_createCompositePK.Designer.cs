...
namespace Api.Migrations
{
    ...
    [Migration("20250110203127_createCompositePK")]
    partial class createCompositePK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExerciseRoutine", b =>
                {
                    ...
                    b.HasKey("RoutinesId", "ExercisesId", "ExercisesUserId");

                    b.HasIndex("ExercisesId", "ExercisesUserId");
            ...
            modelBuilder.Entity("api.Models.Routine", b =>
                {
                    b.HasOne("api.Models.Schedule", "Schedule")
                        .WithOne("Routine")
                        .HasForeignKey("api.Models.Routine", "ScheduleId");
