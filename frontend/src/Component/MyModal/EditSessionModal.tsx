      ...
      <Modal.Body className="p-0 border-0 d-flex flex-column justify-content-start">
              ...
              >
                ...
                >
                  {schedule.map((item, index) => {
                    ...
                    if (item.exercises.length === null) return;
        ...
        {!event && (
          <div className="d-flex flex-column Add-Routine-container">
            ...
            <button
              className="border-0 bg-transparent p-0 d-flex align-items-center Add-Routine text-start w-fit"
              onClick={() => setIsAddingRoutine(!isAddingRoutine)}
            >
              <img
                src={Plus}
                alt="icon"
                className={isAddingRoutine ? "icon-rotated" : "icon-default"}
              />
              Add routine
            </button>
            <CSSTransition
